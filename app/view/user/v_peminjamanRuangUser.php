    ...
    <div id="main">
        <div class="container clearfix">
            ...
            <div class="toolbar clearfix section">
                <a class="btn btn-raised left" href="<?php echo URL; ?>/peminjamanRuangUser/tambah" ><i
                        class="md md-search"></i>Tambah Peminjaman Ruang</a>
            </div>
            <br>
            <br>
                        ...
                        <table>
                            ...
                            <?php foreach ($this->data as $key => $value){?>
                                <tr>
                                    ...
                                    <td><a href="peminjamanRuangUser/detail/<?php echo $value['nama_kegiatan'] ?>"><i class="fa fa-eye"></i></a>
                                    </td>
                                    </tr>
                            <?php } ?>
                            </tbody>
