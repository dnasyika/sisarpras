            ...
            <div class="box box-primary">
                <div class="box-body">
                    ...
                    <div style="margin-top: 20px">
                        <div class="col-md-6">
                            <a href="<?php echo URL; ?>/peminjamanBarang/verifikasiKtu/<?php echo $value['nama_kegiatan'] ?>" style="margin-left: 10px" class="btn btn-sm btn-default"> <i
                                        class="fa fa-btn fa-check"></i>Verifikasi</a>
                            <a href="<?php echo URL; ?>/peminjamanBarang" style="margin-left: 10px" class="btn btn-sm btn-default">
